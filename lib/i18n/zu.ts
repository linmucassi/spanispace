const zu = {
  ...
  course: {
    back: 'Ukuqeqeshwa',
    lessons: 'izifundo ezingu-{n}',
    minRead: 'imizuzu engu-{n} yokufunda',
    min: 'imizuzu engu-{n}',
    read: '{d} yokufunda',
    free: 'Mahhala',
    paid: 'Kuyakhokhwa',
    selfPaced: 'Uzifundela ngesikhathi sakho',
    start: 'Qala isifundo 1',
    aboutTitle: 'Izwi ngaphambi kokuqala',
    position: '{n} kwezingu-{total}',
    progressLabel: 'Isifundo {n} kwezingu-{total}',
    outcomes: 'Ekugcineni uzokwazi',
    keyTerms: 'Amagama abalulekile ngolimi olulula',
    activity: 'Zama lokhu, mahhala',
    finished: 'Uqedile {course}',
    pickTrack: 'Khetha indlela yomsebenzi',
    browseJobs: 'Bheka imisebenzi',
    previous: 'Okwedlule',
    next: 'Okulandelayo',
    navLabel: 'Ukuhamba phakathi kwezifundo',
    howToChoose: 'Ungakhetha kanjani phakathi kwazo',
    howToRead: 'Ungazifunda kanjani lezi zibalo',
    roles: 'izikhundla ezingu-{n}',
    role: 'isikhundla esisodwa',
    lockedTitle: 'Ngena ukuze ufunde lesi sifundo',
    lockedBody: 'Izifundo eziphelele, amagama abalulekile nemisebenzi kungabafundi abangenile kuphela. Kuthatha umzuzu nje ukwenza i-akhawunti yamahhala.',
    signIn: 'Ngena',
    createAccount: 'Yenza i-akhawunti yamahhala',
    signInToStart: 'Ngena ukuze uqale lesi sifundo',
    lessonsComplete: 'izifundo ezingu-{n} kwezingu-{total} ziqediwe',
    done: 'Kwenziwe',
    markComplete: 'Phawula isifundo njengesiqediwe',
    completed: 'Kuqediwe',
  },
  academic: {
  ...
  auth: {
    ...
    firstName: 'Igama',
    firstNamePlaceholder: 'Sipho',
    lastName: 'Isibongo',
    lastNamePlaceholder: 'Dlamini',
