const zu = {
  ...
  training: {
    ...
    pricingNote: 'Izifundo zabaqalayo zimahhala. Izifundo ezithuthukisiwe ziyakhokhelwa.',
    filterLabel: 'Hlunga izifundo ngezinga',
    filterAll: 'Zonke izifundo',
    filterBeginner: 'Abaqalayo, mahhala',
    filterAdvanced: 'Ezithuthukisiwe, kuyakhokhwa',
    levelBeginner: 'Abaqalayo',
    levelAdvanced: 'Ezithuthukisiwe',
    free: 'Mahhala',
    paid: 'Kuyakhokhwa',
    pricedByProvider: 'Intengo ibekwa umhlinzeki',
    selfPaced: 'Uzifundela ngesikhathi sakho',
    startFree: 'Qala Mahhala',
    openOnProvider: 'Vula ku-{provider}',
