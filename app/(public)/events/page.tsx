      ...
      <div className="max-w-6xl mx-auto">
        ...
        {!loading && events.length === 0 && (
          <div className="text-center py-20">
            <Calendar className="h-12 w-12 text-ink-300 mx-auto mb-4" />
            <p className="text-ink-500 text-lg">{t('events.noEvents')}</p>
          </div>
        )}
            ...
            {events.map((event) => {
              ...
              return (
                <Link
                  ...
                  className="group bg-white rounded-2xl border border-ink-100 shadow-sm hover:shadow-md hover:border-brand-200 transition-all p-6 flex flex-col"
                >
                  {/* Badges row */}
                  ...
                  {/* Title */}
                  <h3 className="text-lg font-bold text-ink-900 group-hover:text-brand-600 transition-colors mb-3 line-clamp-2">
                    {event.title}
                  </h3>
                  ...
                  {event.skills_focus && event.skills_focus.length > 0 && (
                    <div className="flex flex-wrap gap-1.5 mb-4">
                      ...
                      {event.skills_focus.length > 4 && (
                        <span className="px-2 py-0.5 bg-ink-50 text-ink-500 text-xs font-medium rounded-full">
                          +{event.skills_focus.length - 4}
                        </span>
                      )}
                    </div>
